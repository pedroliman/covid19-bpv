...
exper.design.u <- exper.design[exper.design$twp.success==FALSE&exper.design$c %in% c(.025, 0.05, 0.1, 0.2, 0.4),]
...
guess <- as.data.frame(guess)
   ...
   solved <- TRUE
    ...
    print(solved)}
print(Sys.time())
write.csv(sol.explore,"INTERMEDIATE/sol.explore-step12.csv",row.names = FALSE)
write.csv(exper.design,"INTERMEDIATE/exper.design-step12.csv",row.names = FALSE)
