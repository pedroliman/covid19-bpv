...
```{r}
sol.explore <- read.csv("INTERMEDIATE/sol.explore-step2.csv")
exper.design <- read.csv("INTERMEDIATE/exper.design-step2.csv")
```
  ...
  if(dim(same.tFinal)[1]==0){
   ...
   print(tFinal)
    ...
    # we use the shooting method solution. 
        ...
        print(paste("R_0 vec is",R_0.vec))
        for(R_0 in R_0.vec){
    ...
    exper.design[case.run,"twp.success3"] <- !inherits(res,"try-error")
   ...
   solved <- TRUE
    ...
    print(solved)}
print(Sys.time())
write.csv(sol.explore,"INTERMEDIATE/sol.explore-step3.csv")
write.csv(exper.design,"INTERMEDIATE/exper.design-step3.csv")
