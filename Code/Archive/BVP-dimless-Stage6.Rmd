...
```{r}
sol.explore <- read.csv("INTERMEDIATE/sol.explore-step5.csv")
exper.design <- read.csv("INTERMEDIATE/exper.design-step5.csv")
```
...
guess <- as.data.frame(guess)
   ...
   solved <- TRUE
    ...
    print(solved)}
print(Sys.time())
write.csv(sol.explore,"INTERMEDIATE/sol.explore-step6.csv",row.names = FALSE)
write.csv(exper.design,"INTERMEDIATE/exper.design-step6.csv",row.names = FALSE)
