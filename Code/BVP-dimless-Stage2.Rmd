...
```{r}
sol.explore <- read.csv("INTERMEDIATE/sol.explore.csv")
exper.design <- read.csv("INTERMEDIATE/exper.design.csv")
```
...
for (case.run in exper.design.u$case.id){
  ...
  if(dim(same.tFinal)[1]==0){
   ...
   solved <- TRUE
    ...
    print(solved)}
print(Sys.time())
write.csv(sol.explore,"INTERMEDIATE/sol.explore-step2.csv")
write.csv(exper.design,"INTERMEDIATE/exper.design-step2.csv")
